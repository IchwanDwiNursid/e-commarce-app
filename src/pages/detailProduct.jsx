...
import { geDetailProducts } from "../services/product.service.js";
        ...
        {Object.keys(product).length > 0 && (
          <div className="flex font-sans max-w-xl">
            ...
            <form className="flex-auto p-6">
              ...
              >
                Free shipping on all continental Indonesian orders.
              </p>
            </form>
          </div>
        )}
